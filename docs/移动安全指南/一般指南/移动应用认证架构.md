...
- [弹簧（爪哇）](https://projects.spring.io/spring-security)
- [支柱（Java）](https://struts.apache.org/security/)
- [拉维尔 (PHP)](https://laravel.com/docs/9.x/authentication)
...
- [弹簧（爪哇）](https://docs.spring.io/spring-boot/docs/current/reference/html/web.html#web.spring-session)
- [Rails 上的 Ruby](https://guides.rubyonrails.org/security.html#session-expiry)
- [PHP](https://php.net/manual/en/session.configuration.php#ini.session.gc-maxlifetime)
- [ASP网](https://docs.microsoft.com/en-us/dotnet/api/system.web.sessionstate.httpsessionstate.timeout)
...
- [弹簧（爪哇）](https://docs.spring.io/autorepo/docs/spring-security/4.1.x/apidocs/org/springframework/security/web/authentication/logout/SecurityContextLogoutHandler.html)
- [Rails 上的 Ruby](https://guides.rubyonrails.org/security.html)
